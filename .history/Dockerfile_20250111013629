...
# Pre-run Streamlit to build the cache
RUN bash -c "source firedrake/bin/activate && cd /home/firedrake/VIAMRWebApp && streamlit run streamlitapp.py --server.address 0.0.0.0 --server.port 7860 & sleep 20 && pkill streamlit"
